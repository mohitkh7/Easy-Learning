...
class Person(models.Model):
	...
	profile_picture 	= models.ImageField(upload_to="profile_picture/",default="/profile_picture/default_profile_picture.png")
...
def update_score_on_vote(sender, instance, **kwargs):
	...
	'''
	sum_of_vote = Vote.objects.filter(resource=instance.resource).aggregate(Sum('value'))
